...
public enum Vantagem implements Requisitavel, Identificavel{
	...
	ATRAENTE("Atraente", "Não é segredo que pessoas bonitas têm mais " +
			...
			new Requisito(Progresso.NOVATO, Atributo.VIGOR.get().setNivelDado(6))),
	...
	CORAJOSO("Corajoso", "Aqueles com esta Vantagem aprenderam " +
			...
			new Requisito(Progresso.NOVATO, Atributo.ESPIRITO.get().setNivelDado(6))),
	...
	CURA_RAPIDA("Cura Rápida", "Alguns indivíduos parecem se curar mais " +
			...
			new Requisito(Progresso.NOVATO, Atributo.VIGOR.get().setNivelDado(8))),
	...
	LIGEIRO("Ligeiro", "A Movimentação do herói é aumentada em " +
			...
			new Requisito(Progresso.NOVATO, Atributo.AGILIDADE.get().setNivelDado(6))),
	...
	LINGUISTA("Linguista", "O personagem possui um ouvido para idiomas " +
			...
			new Requisito(Progresso.NOVATO, Atributo.ASTUCIA.get().setNivelDado(6))),
	...
	MUITO_ATRAENTE("Muito Atraente", "Seu herói é lindo de morrer. O seu Carisma é " +
			...
			new Requisito(Progresso.NOVATO, Vantagem.ATRAENTE)),
	...
	MUSCULOSO("Musculoso", "O seu lutador é muito grande ou talvez apenas " +
			...
			new Requisito(Progresso.NOVATO, Atributo.FORCA.get().setNivelDado(6), Atributo.VIGOR.get().setNivelDado(6))),
	...
	RESISTENCIA_ARCANA("Resistência Arcana", "Este indivíduo é particularmente resistente " +
			...
			new Requisito(Progresso.NOVATO, Atributo.ESPIRITO.get().setNivelDado(8))),
	...
	RESISTENCIA_ARCANA_APRIMORADA("Resistência Arcana Aprimorada", "Este indivíduo é particularmente resistente " +
			...
			"amigáveis precisam subtrair esse modificador para " +
			"afetar o herói resistente.", Jogo.SAVAGE_WORLDS, TipoVantagem.VANTAGEM_ANTECEDENTE,
			new Requisito(Progresso.NOVATO, Vantagem.RESISTENCIA_ARCANA)),
	...
	PODRE_RICO("Podre de Rico", "Este personagem é muito rico. Ele possui " +
			...
			new Requisito(Progresso.NOVATO, new RequisitoDisjuntivo(Vantagem.NOBRE, Vantagem.RICO))),
	...
	SORTE_GRANDE("Sorte Grande", "Como a vantagem Sorte, mas o jogador saca dois Benes " +
			...
			new Requisito(Progresso.NOVATO, Vantagem.SORTE)),
	...
	ARMA_PREDILETA("Arma Predileta", "O herói conhece uma única arma (Excalibur, " +
			...
			new Requisito(Progresso.NOVATO, new RequisitoDisjuntivo(
					Pericia.ATIRAR.get().setNivelDado(10), Pericia.LUTAR.setNivelDado(10))
			)),
	...
	ARMA_PREDILETA_APRIMORADA("Arma Predileta Aprimorada", "Como a vantagem Arma Predileta, mas o bônus ao usar a arma " +
			...
			new Requisito(Progresso.VETERANO, Vantagem.ARMA_PREDILETA)),
	...
	ARTISTA_MARCIAL("Artista Marcial", "Este personagem é altamente treinado em " +
			...
			new Requisito(Progresso.NOVATO, Pericia.LUTAR.get().setNivelDado(6))),
	...
	ARTISTA_MARCIAL_APRIMORADO("Artista Marcial Aprimorado", "Assim como a vantagem Artista Marcial." +
			...
			new Requisito(Progresso.VETERANO, Vantagem.ARTISTA_MARCIAL, Pericia.LUTAR.get().setNivelDado(10))),

	ATACAR_PRIMEIRO("Atacar Primeiro", "Uma vez por turno o herói (se não Abalado) " +
			"recebe um ataque livre de Lutar contra um " +
			"único inimigo que se mova adjacente a ele. Isso " +
			"interrompe automaticamente a ação do oponente e " +
			"não custa ao herói a sua ação caso esteja em Espera " +
			"ou ainda não tenha agido nesta rodada.", Jogo.SAVAGE_WORLDS, TipoVantagem.VANTAGEM_COMBATE,
			new Requisito(Progresso.NOVATO, Atributo.AGILIDADE.get().setNivelDado(8))),

	ATACAR_PRIMEIRO_APRIMORADO("Atacar Primeiro Aprimorado", "Como a vantagem Atacar Primeiro, " +
			"mas o herói pode fazer um ataque livre contra cada e todo inimigo que se mover" +
			"adjacente a ele.", Jogo.SAVAGE_WORLDS, TipoVantagem.VANTAGEM_COMBATE,
			new Requisito(Progresso.HEROICO, Vantagem.ATACAR_PRIMEIRO)),

	ATIRADOR("Atirador", "O herói é excelente em efetuar disparos " +
			"controlados e precisos. Caso não se mova em " +
			"um turno, pode atirar como se tivesse efetuado a " +
			"manobra Mirar. Atirador nunca pode ser usado " +
			"com uma Cadência de Tiro maior que 1. " +
			"Atirador funciona tanto com Arremessar quanto " +
			"com Atirar.", Jogo.SAVAGE_WORLDS, TipoVantagem.VANTAGEM_COMBATE,
			new Requisito(Progresso.EXPERIENTE)),

	BLOQUEAR("Bloquear", "Heróis que participam frequentemente em " +
			"combates corpo a corpo são mais hábeis em defesa " +
			"pessoal do que a maioria. Eles aprendem não só a " +
			"atacar, mas também como bloquear os golpes de " +
			"seus oponentes. Um guerreiro com esta Vantagem " +
			"adiciona +1 a seu Aparar.", Jogo.SAVAGE_WORLDS, TipoVantagem.VANTAGEM_COMBATE,
			new Requisito(Progresso.NOVATO, Pericia.LUTAR.get().setNivelDado(8))),
