...
public class Ciborgue extends Raca {
	private static final String nome = "Ciborgue";
	private static final String desc = "Pouca coisa é mais assustadora em batalha do que um " + 
			...
			"podem arcar com o procedimento para pessoal de confiança. " + 
			"Contudo, mais e mais ciborgues estão começando a " + 
			"encontrar o seu caminho até o setor privado. " + 
			"\n• Aprimorado: Ciborgues são construídos para serem " + 
			"bestas cibernéticas. Eles começam com um único Aprimoramento " + 
			"Nível das Ruas com uma Tensão de 1. " + 
			...
			"\n• Vulnerabilidade a PEM: Ciborgues sofrem dano completo " + 
			"de Armas PEM. " + 
			...
			"uma fria máquina de guerra. Eles sofrem uma penalidade " + 
			"de -2 no Carisma quando lidam com não Ciborgues. " + 
			"\n• Dieta Especializada: Ciborgues não podem digerir " + 
			"comida normal e requerem comida especial com nutrientes " + 
			"para manterem os seus cérebros saudáveis. Isso " + 
