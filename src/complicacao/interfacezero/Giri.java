...
public class Giri extends Complicacao {
	public static final String nome = "Giri";
	public static final String desc = "Às vezes, você apenas deve a alguém de uma maneira que dinheiro "
